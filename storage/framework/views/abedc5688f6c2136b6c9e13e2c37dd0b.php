...
<div class="bill-wrap">
  ...
  <div class="bill-hero">
    ...
    <div class="controls" style="margin-top:6px;">
      <div class="stats">
        <span class="chip"><span class="dot dot-info"></span> Rows <strong><?php echo e($ads->count()); ?></strong></span>
        <span class="chip"><span class="dot dot-danger"></span> Due Rows <strong><?php echo e($pageDueCount); ?></strong></span>
        <span class="chip"><span class="dot dot-success"></span> Due (Page) <strong>Rs. <?php echo e(number_format($pageDueNpr,2)); ?></strong></span>
      </div>
    ...
    <form method="GET" action="<?php echo e(route('invoice.pendingBills')); ?>" class="searchbar">
      <i class="fa-solid fa-magnifying-glass icon"></i>
      <div class="w-100">
        <input name="search" value="<?php echo e($search); ?>" placeholder="Search by name, display name or phone…">
      </div>
  ...
  <div class="table-shell">
    <table class="fancy">
      ...
      <?php $__empty_1 = true; $__currentLoopData = $ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <tr
          data-due="<?php echo e($isDue ? '1' : '0'); ?>"
          data-billstate="<?php echo e($currentState); ?>"
        >
          <td>
            <div class="d-flex align-items-center gap-2">
              <img class="avatar" src="<?php echo e(asset('uploads/customers/' . ($ad->customer_profile_picture ?: 'default.jpg'))); ?>" alt="">
              <div>
                <a href="<?php echo e(route('customer.details', ['id' => $ad->customer_id])); ?>" class="text-decoration-none" style="color:var(--text)">
                  <strong><?php echo e($ad->customer_display_name ?? $ad->customer_name); ?></strong>
                </a>
                <div class="sub"><?php echo e($ad->customer_email); ?></div>
              </div>
            </div>
          </td>
          ...
          <td>
            <div class="wa-actions">
              <span class="thin"><?php echo e($ad->customer_phone); ?></span>
              <a class="btn-icon" title="Open WhatsApp" target="_blank" href="https://wa.me/977<?php echo e(preg_replace('/\D/','',$ad->customer_phone)); ?>">
                <i class="fa-brands fa-whatsapp"></i>
              </a>
              <button type="button" class="btn-icon copy" title="Copy number" data-copy="<?php echo e($ad->customer_phone); ?>">
                <i class="fa-regular fa-copy"></i>
              </button>
            </div>
          </td>

          <td class="hide-md">Rs. <?php echo e(number_format($ad->ad_npr ?? 0, 2)); ?></td>

          <td>
            <?php if($isDue): ?>
              <span class="badge badge-danger">Rs. <?php echo e(number_format($ad->ad_npr ?? 0, 2)); ?></span>
            <?php else: ?>
              <span class="badge badge-success">No Due</span>
            <?php endif; ?>
          </td>

          <td class="hide-md thin"><?php echo e(\Carbon\Carbon::parse($ad->ad_created_at)->format('Y-m-d H:i')); ?></td>

          <td>
            <div class="d-flex flex-column">
              <span class="thin">#<?php echo e($ad->ad_id); ?></span>
              <span class="pill pill-<?php echo e($paySlug); ?>"><?php echo e($ad->ad_payment); ?></span>
            </div>
          </td>

          <td style="min-width:210px">
            <div class="select-shell billing-select"
                  data-state="<?php echo e($currentState); ?>"
                  data-action="<?php echo e(route('invoice.updateBillingStatus', $ad->ad_id)); ?>">
              <select name="billing_status" data-ad="<?php echo e($ad->ad_id); ?>">
                <?php $__currentLoopData = $billingStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($status); ?>" <?php echo e($currentState === $status ? 'selected' : ''); ?>>
                    <?php echo e($status); ?>
          ...
          <td class="hide-md">
            <div class="d-flex gap-2">
              <a href="<?php echo e(route('customer.details', ['id' => $ad->customer_id])); ?>" class="btn btn-sm btn-outline-primary">View</a>
              <a href="<?php echo e(route('admin.customer.impersonate', $ad->customer_id)); ?>" class="btn btn-sm btn-outline-secondary" target="_blank">Portal</a>
            </div>
          </td>
        </tr>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/invoice/bills.blade.php ENDPATH**/ ?>