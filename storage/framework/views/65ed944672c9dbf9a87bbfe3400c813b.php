...
<div class="container-fluid">
    <div class="alert alert-info d-flex align-items-right" style="background-color: #646564; color: white;">
        <div class="tfund"><strong>Total Other Income: </strong> Rs <?php echo e(number_format($totalOtherIncome, 2)); ?></div>
        <div class="tfund ms-3"><strong>Total Opening Balance: </strong> Rs <?php echo e(number_format($totalOpeningBalance, 2)); ?></div>
        ...
        <tbody id="otherIncomeTable">
            <tr>
                <form id="addOtherIncomeForm">
                    <?php echo csrf_field(); ?>
                    <td><input type="date" name="date" class="form-control" value="<?php echo e(now()->toDateString()); ?>" required></td>
            ...
            <?php $__currentLoopData = $other_incomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="row-<?php echo e($income->id); ?>">
                    <td><?php echo e($income->date); ?></td>
                    <td><?php echo e($income->contact_number); ?></td>
                    <td><?php echo e($income->customer_name); ?></td>
                    <td><?php echo e($income->amount); ?></td>
                    <td><?php echo e($income->remarks); ?></td>
                    <td><?php echo e($income->income_type); ?></td>
                    <td>
                        <button class="btnn btnn-primary edit-btnn" onclick="editRow(<?php echo e($income->id); ?>)">Edit</button>
                        <button class="btnn btnn-danger" onclick="deleteRow(<?php echo e($income->id); ?>)">Delete</button>
                    </td>
                </tr>
    ...
    <div class="previous-months">
        ...
        <?php $__currentLoopData = $previousMonths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button class="btnn btnn-primary" onclick="loadMonthData('<?php echo e($month->year); ?>', '<?php echo e($month->month); ?>')">
...
<datalist id="customers">
    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($customer->contact_number); ?>"><?php echo e($customer->name); ?></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/other_income/index.blade.php ENDPATH**/ ?>