...
<form method="POST" action="/ad-management/adaccount/store">
    ...
    <select name="account_name" class="js-example-basic-multiple" required>
        ...
        <?php $__currentLoopData = $adAccountOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($option->Ad_Account_Display); ?>"><?php echo e($option->Ad_Account_Display); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
    <input type="date" name="active_since" value="<?php echo e(date('Y-m-d')); ?>">
...
<table>
    ...
    <?php $__currentLoopData = $adAccountsWithUSD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $adAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr id="row-adaccount-<?php echo e($adAccount->id); ?>">
            <td><input type="checkbox" class="select-checkbox" data-id="<?php echo e($adAccount->id); ?>"></td>
            <td><?php echo e($index + 1); ?></td>
            <td><?php echo e($adAccount->account_name); ?></td>
            <td contenteditable="false" class="editable date-field" data-field="active_since" data-id="<?php echo e($adAccount->id); ?>"><?php echo e($adAccount->active_since); ?></td>
            <td contenteditable="false" class="editable date-field" data-field="threshold_reached_date" data-id="<?php echo e($adAccount->id); ?>"><?php echo e($adAccount->threshold_reached_date ?? 'N/A'); ?></td>
            <td class="readonly" data-field="initial_remaining_days" data-id="<?php echo e($adAccount->id); ?>"><?php echo e($adAccount->remaining_days); ?></td>
            <td contenteditable="false" class="editable" data-field="account_threshold" data-id="<?php echo e($adAccount->id); ?>"><?php echo e($adAccount->account_threshold); ?></td>
            <td contenteditable="false" class="editable" data-field="running_ads_balance" data-id="<?php echo e($adAccount->id); ?>"><?php echo e($adAccount->running_ads_balance_updated); ?></td>
            <td class="readonly" data-field="targeted_budget" data-id="<?php echo e($adAccount->id); ?>"><?php echo e($adAccount->targeted_budget_updated); ?></td>
            <td><?php echo e(isset($adAccount->usd_value) ? number_format($adAccount->usd_value, 2) : '0.00'); ?></td>
            <td><?php echo e($adAccount->new_applied_history ?? 'N/A'); ?></td>
           <td>
    <button class="btn btn-primary btn-sm edit-btn" onclick="editRow(<?php echo e($adAccount->id); ?>)">Edit</button>
    <button class="btn btn-success btn-sm save-btn" onclick="saveRow(<?php echo e($adAccount->id); ?>)" style="display:none;">Save</button>
    <form method="POST" action="/ad-management/adaccount/<?php echo e($adAccount->id); ?>" style="display:inline;background: none;border: none;padding: 0px;">
        <?php echo csrf_field(); ?>
...
<div style="display: flex; gap: 20px; align-items: right;">
    <form method="POST" action="<?php echo e(route('adaccount.group.store')); ?>" style="display: inline-block;width: 50%;"">
        <?php echo csrf_field(); ?>
        <input type="text" name="group_name" placeholder="Create New Group" required>
        <button type="submit">Create Group</button>
    </form>
<form method="POST" action="<?php echo e(route('adaccount.grouped.store')); ?>" style="display: inline-block; width: 100%;">
    <?php echo csrf_field(); ?>
    ...
    <div class="row">
        <?php $__currentLoopData = $groupedAdAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $accounts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($counter % $rowLimit == 0): ?>
                    <?php $tableCounter++; ?>
                    <?php if($tableCounter > 1 && ($tableCounter - 1) % 3 == 0): ?>
                ...
                <?php if($counter % $rowLimit == 0 || $counter % $rowLimit < $rowLimit): ?>
                    <?php if($counter % $rowLimit == 0): ?>
                        <tr>
                            <td colspan="3"><strong><?php echo e($groupName); ?></strong></td>
                        </tr>
                    <?php endif; ?>
                    <tr>
                        <td><?php echo e($account->ad_account_name); ?></td>
                        <td>
                            <form method="POST" action="<?php echo e(route('adaccount.grouped.delete', $account->id)); ?>" style="display:inline;background: none;border: none;padding: 0px;">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="btn btn-danger btn-sm">Delete</button>
                            </form>
                ...
                <?php if($counter % $rowLimit == 0 || ($loop->last && $loop->parent->last)): ?>
                            </tbody>
                        </table>
                    </div>
                <?php endif; ?>
...
<div>
    <?php echo e($adAccountsWithUSD->links()); ?>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/admin/adAccount/adManagement.blade.php ENDPATH**/ ?>