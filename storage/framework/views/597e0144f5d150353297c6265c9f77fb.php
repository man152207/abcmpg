...
<form method="post" action="<?php echo e(route('admin.daily-logs.store')); ?>" id="dailyLogForm">
  <?php echo csrf_field(); ?>
  ...
  <div class="card p-3 hidden" id="metaCard">
    <div class="meta-grid">
      <div>
        ...
        <input id="log_date" type="date" name="log_date" value="<?php echo e(old('log_date', now()->toDateString())); ?>" required>
      </div>
      <div>
  ...
  <div class="card p-3 hidden" id="summaryCard">
    ...
    <textarea name="summary" rows="3" placeholder="आजको मुख्य उपलब्धि, tomorrow को priority, blockers…"
              style="width:100%;border:1px solid #e5e7eb;border-radius:8px;padding:10px;font-size:var(--fs-base)"><?php echo e(old('summary')); ?></textarea>
  </div>
  ...
  <div class="sticky-actions hidden" id="actionsBar">
    ...
    <a class="btn" href="<?php echo e(route('admin.daily-logs.index')); ?>">Cancel</a>
  </div>
</form>
...
<script>
  ...
  const currentAdminName = <?php echo json_encode(optional(auth('admin')->user())->name, 15, 512) ?> || 'Me';
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/admin/daily_logs/create.blade.php ENDPATH**/ ?>