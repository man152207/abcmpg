...
<?php $__env->startSection('title', 'Dashboard | MPG Solution'); ?>
...
<div class="account-balance d-flex align-items-center">
    <span class="amount revealed-number" style="background: linear-gradient(to right, #4caf50, #81c784); color: #fff; padding: 8px 16px; border-radius: 8px; font-size: 1.2em; font-weight: bold;">
        Account Balance: Rs <?php echo e(number_format($accountBalance, 2)); ?>
                ...
                <div class="card-row">
                    <div class="summary-card">
                        <div>
                            ...
                            <span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;"><span class="usd">$ <?php echo e(number_format($monthlyAdIncomeSummaries->totalUSD ?? 0, 2)); ?></span> 
                        </div>
                    ...
                    <div class="summary-card">
                        ...
                        <div>
                            ...
                            <span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;"><span class="usd">$ <?php echo e(number_format($monthlyClientSummaries->totalUSD ?? 0, 2)); ?></span> 
                        </div>
...
<div class="summary-card">
    ...
    <i class="fa fa-retweet"></i>
                    ...
                    <div class="summary-card">
                        <div>
                            ...
                            <span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;"><span class="usd">$ <?php echo e(number_format($Cardsummary->totalUSD ?? 0, 2)); ?></span></span>
                        </div>
    ...
    <div>
        ...
        <span class="amount revealed-number usd" style="display: none;">
            <?php if(!empty($activeBonusSeason)): ?>
                <span class="usd">
                    $ <?php echo e(number_format($totalBonusCredit ?? 0, 2)); ?>
    ...
    <span class="amount revealed-number usd" style="display: none;">
        ...
        ?>
        <div class="tfund">
            <strong></strong> Rs <?php echo e(number_format($totalGrossValue, 2)); ?>
...
<span class="amount revealed-number usd" style="display: none;">
    <span class="npr">
        Rs <?php echo e(number_format(($monthlyClientSummaries->totalNRP ?? 0) + ($monthlyExp->totalAmt ?? 0) + ($currentMonthExpenses->total_amount ?? 0), 2)); ?>
...
<span class="amount hidden-number">xxxx.xx</span>
<span class="amount revealed-number usd" style="display: none;">
    <span class="npr">Rs <?php echo e(number_format(floatval(str_replace(',', '', $formattedTotalToBeReceived ?? 0)), 2)); ?></span>
</span>
    ...
    ?>
    <div class="tfund">
        <strong></strong> Rs <?php echo e(number_format($IncomeSummary, 2)); ?>
...
<div class="summary-crd" style="background-color: <?php echo e($backgroundColor); ?>;">
    <div>
        <h6><?php echo e($currentMonthName); ?> <?php echo e($profitText); ?></h6>
        <span class="amount revealed-number usd" style="color: <?php echo e($fontColor); ?>;">
            Rs <?php echo e(number_format($currentMonthProfitNRP, 2)); ?>

        </span>
    </div>
    <i class="fa fa-piggy-bank <?php echo e($iconClass); ?>" style="animation-duration: 1s;"></i>
</div>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;">$ <?php echo e(number_format($previousMonthlyAdIncomeSummaries->totalUSD ?? 0, 2)); ?></td></span>
                    <td><span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;">Rs <?php echo e(number_format($previousMonthlyAdIncomeSummaries->totalNRP ?? 0, 2)); ?></td></span>
                </tr>
                <tr>
                    <td>Expenditures of <?php echo $previousMonthName; ?></td>
                    <td><span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;">$ <?php echo e(number_format($previousMonthlyClientSummaries->totalUSD ?? 0, 2)); ?></td></span>
                    <td><span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;">Rs <?php echo e(number_format(($previousMonthlyClientSummaries->totalNRP ?? 0) + ($previousMonthlyExp->totalAmt ?? 0), 2)); ?></td></span>
                </tr>
                <tr>
                    <td>Profit of <?php echo $previousMonthName; ?></td>
                    <td>-</td>
                    <td><span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;">Rs <?php echo e(number_format(($previousMonthlyAdIncomeSummaries->totalNRP ?? 0) - (($previousMonthlyClientSummaries->totalNRP ?? 0) + ($previousMonthlyExp->totalAmt ?? 0)), 2)); ?></td></span>
                </tr>
                <tr>
                    <td>To be Loaded USD</td>
                    <td><span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;">$ <?php echo e(number_format(($previousMonthlyAdIncomeSummaries->totalUSD ?? 0) - ($previousMonthlyClientSummaries->totalUSD ?? 0), 2)); ?></td></span>
                    <td><span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;">Rs <?php echo e(number_format(
                ...
                <tr>
                    <td>USD Balance</td>
                    <td><span class="amount hidden-number">xxxx.xx</span> <span class="amount revealed-number usd" style="display: none;">$ <?php echo e(number_format($previousCardsummary->totalUSD ?? 0, 2)); ?></td></span>
                    <td>-</td>
                </tr>
            </tbody>
        </table>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>