    ...
    <section class="right" aria-label="Login form">
      ...
      <form method="POST" action="<?php echo e(route('admin.login')); ?>">
        ...
        <div>
          ...
          <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="you@mpg.com.np" required autofocus>
          <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div style="color:#ff8e8e; font-size:12.5px"><?php echo e($message); ?></div> <?php unset($message);
...
(function(){
  ...
  const url  = `<?php echo e(route('api.weather')); ?>?city=${city}`;
...
<?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/admin/login.blade.php ENDPATH**/ ?>