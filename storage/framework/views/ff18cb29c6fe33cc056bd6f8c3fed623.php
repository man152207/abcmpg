...
<div class="container-fluid insight-container">
    <h3 class="mb-4">
        ...
        ?>
        <?php echo e($customer->display_name ?? $customer->name); ?>'s Meta Ad Insights
    </h3>
...
<form action="<?php echo e(route('insights.fetchFromApi', $customerId ?? 1)); ?>" method="POST" class="insight-form" id="insightForm">
    <?php echo csrf_field(); ?>
    ...
    <div class="tab-content" id="insightsTabContent">
        ...
        <div class="tab-pane fade show active" id="campaigns" role="tabpanel">
            ...
            <table class="table table-bordered table-hover" id="campaignsTable">
                ...
                <tbody>
                    <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($index + 1); ?></td>
                        <td class="left-align editable-td" data-id="<?php echo e($row->id); ?>" data-type="campaign" ondblclick="makeEditable(this)">
                            <?php echo e($row->campaign_name); ?>

                        </td>
                        <td>
                            <span class="badge 
                                <?php if(strtolower($row->delivery) === 'active'): ?> badge-success
                                <?php elseif(strtolower($row->delivery) === 'completed'): ?> badge-primary
                                <?php elseif(strtolower($row->delivery) === 'paused'): ?> badge-warning
                                <?php elseif(strtolower($row->delivery) === 'in_review'): ?> badge-info
                                <?php elseif(strtolower($row->delivery) === 'rejected'): ?> badge-danger
                                <?php else: ?> badge-secondary <?php endif; ?>">
                                <?php echo e(ucfirst(strtolower($row->delivery))); ?>
                        ...
                        <td>
                            <div style="display: flex; gap: 5px; justify-content: center;">
                                <form action="<?php echo e(route('insights.refetch', ['id' => $row->id, 'type' => 'campaign'])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-sm btn-warning btn-insight">Fetch</button>
                                </form>
                                <form action="<?php echo e(route('insights.delete', ['id' => $row->id, 'type' => 'campaign'])); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this report?');">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="tab-pane fade" id="adsets" role="tabpanel">
            ...
            <table class="table table-bordered table-hover" id="adsetsTable">
                ...
                <tbody>
                    <?php $__currentLoopData = $adsets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($index + 1); ?></td>
                        <td class="left-align editable-td" data-id="<?php echo e($row->id); ?>" data-type="adset" ondblclick="makeEditable(this)">
                            <?php echo e($row->adset_name); ?>
                        ...
                        <td>
                            <div style="display: flex; gap: 5px; justify-content: center;">
                                <form action="<?php echo e(route('insights.refetch', ['id' => $row->id, 'type' => 'adset'])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-sm btn-warning btn-insight">Fetch</button>
                                </form>
                                <form action="<?php echo e(route('insights.delete', ['id' => $row->id, 'type' => 'adset'])); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this ad set?');">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="btn btn-sm btn-danger btn-insight">Delete</button>
                                </form>
        ...
        <div class="tab-pane fade" id="ads" role="tabpanel">
            ...
            <table class="table table-bordered table-hover" id="adsTable">
                ...
                <tbody>
                    <?php $__currentLoopData = $ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($index + 1); ?></td>
                        <td class="left-align editable-td" data-id="<?php echo e($row->id); ?>" data-type="ad" ondblclick="makeEditable(this)">
                            <?php echo e($row->ad_name); ?>
                        ...
                        <td>
                            ...
                            ?>
                            <?php echo e($adset->adset_name ?? 'N/A'); ?>
                        ...
                        <td>
                            <div style="display: flex; gap: 5px; justify-content: center;">
                                <form action="<?php echo e(route('insights.refetch', ['id' => $row->id, 'type' => 'ad'])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-sm btn-warning btn-insight">Fetch</button>
                                </form>
                                <form action="<?php echo e(route('insights.delete', ['id' => $row->id, 'type' => 'ad'])); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this ad?');">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="btn btn-sm btn-danger btn-insight">Delete</button>
                                </form>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function autoFetchInsights() {
        ...
        try {
            const response = await fetch('<?php echo e(route('insights.fetchFromApi', $customerId ?? 1)); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/customer/insights.blade.php ENDPATH**/ ?>