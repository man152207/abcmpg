...
<script>
  const api = {
    list: '<?php echo e(route('admin.prompts.list')); ?>',
    store: '<?php echo e(route('admin.prompts.store')); ?>',
    update: id => '<?php echo e(url('admin/prompts')); ?>/' + id,
    destroy: id => '<?php echo e(url('admin/prompts')); ?>/' + id,
    duplicate: id => '<?php echo e(url('admin/prompts')); ?>/' + id + '/duplicate',
    toggleFav: id => '<?php echo e(url('admin/prompts')); ?>/' + id + '/toggle-fav',
    quickSearch: '<?php echo e(route('admin.customers.quickSearch')); ?>',
  };
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/admin/prompts/index.blade.php ENDPATH**/ ?>