...
<div class="wrapper mpg-layout">
    ...
    <div class="d-flex align-items-center">
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-lg-inline-block">
          <a href="<?php echo e($isReceptionOnly ? route('recp.dashboard') : route('admin.dashboard')); ?>" class="nav-link">Home</a>
        </li>
      </ul>
    </div>
    ...
    <div class="collapse navbar-collapse" id="mpgNavbarCollapse">
        ...
        <div class="mx-lg-auto my-2 my-lg-0">
          <div class="d-flex flex-wrap align-items-center justify-content-center" style="gap:.4rem;">
            <span class="mpg-chip mpg-chip-primary">
              Today: $<?php echo e(number_format($totalUSD, 2, '.', ',')); ?>

            </span>
            <span class="mpg-chip mpg-chip-primary">
              Today: Rs.<?php echo e(number_format((float)$totalNPR, 2, '.', ',')); ?>

            </span>
            <a href="<?php echo e(url('/admin/dashboard/ads/summary')); ?>" class="mpg-chip mpg-chip-info">
              All Summary
            </a>
            <div class="wxbox">
              <span id="wxIcon">⛅</span>
      ...
      <ul class="navbar-nav ml-auto mpg-nav-actions">
        <?php if(!$isReceptionOnly): ?>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('boosting.index')); ?>"
               class="nav-link mpg-action-btn <?php echo e(request()->routeIs('boosting.*') ? 'active' : ''); ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('admin.prompts.index')); ?>"
               class="nav-link mpg-action-btn <?php echo e(request()->routeIs('admin.prompts.*') ? 'active' : ''); ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('admin.2fa.index')); ?>" class="nav-link mpg-action-btn">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link mpg-user-dropdown" data-toggle="dropdown" href="#">
            <img src="<?php echo e($avatar); ?>" class="img-circle elevation-2 mpg-user-avatar" alt="User Image">
            <span class="d-none d-lg-inline"><?php echo e($adminUser?->name); ?></span>
          </a>
          <div class="dropdown-menu dropdown-menu-right">
            <a href="<?php echo e(route('admin.profile.edit')); ?>" class="dropdown-item">
              <i class="fas fa-user mr-2"></i> Profile
            </a>
            <?php if(!$isReceptionOnly && $isSuperAdmin): ?>
              <a href="<?php echo e(route('admin.user.add')); ?>" class="dropdown-item">
                <i class="fas fa-user-plus mr-2"></i> Add User
              </a>
              <a href="<?php echo e(route('admin.user.show')); ?>" class="dropdown-item">
    ...
    <div id="qrModal">
      ...
      <div id="qrModalBody">
        <div class="qr-grid" id="qrGrid">
          <?php $__currentLoopData = $qrImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
              $rel  = str_replace(public_path(), '', $image);
              $name = pathinfo($image, PATHINFO_FILENAME);
            ?>
            <div class="qr-item" data-src="<?php echo e($rel); ?>" data-name="<?php echo e($name); ?>">
              <img src="<?php echo e($rel); ?>" alt="<?php echo e($name); ?>" loading="lazy" decoding="async">
              <div class="qr-label"><?php echo e($name); ?></div>
            </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 mpg-layout">
    <a href="<?php echo e($isReceptionOnly ? route('recp.dashboard') : '/admin/dashboard/ads_list'); ?>" class="brand-link mpg-layout">
      <img src="<?php echo e(asset('dist/img/Brand-icon2.png')); ?>" alt="MPG" class="brand-image img-circle elevation-3 mpg-layout">
      ...
      <nav class="mt-2 mpg-layout">
        <ul class="nav nav-pills nav-sidebar flex-column mpg-layout" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item mpg-layout">
            <a href="<?php echo e($isReceptionOnly ? route('recp.dashboard') : route('admin.dashboard')); ?>"
               class="nav-link mpg-layout <?php echo e(request()->routeIs('admin.dashboard') || request()->routeIs('recp.dashboard') ? 'active' : ''); ?>">
          ...
          <?php if($canSeeReception): ?>
            <?php $recpActive = request()->is('admin/recp*') || request()->routeIs('recp.*'); ?>
            <li class="nav-item has-treeview mpg-layout <?php echo e($recpActive ? 'menu-open' : ''); ?>">
              <a href="#" class="nav-link mpg-layout <?php echo e($recpActive ? 'active' : ''); ?>">
              ...
              <ul class="nav nav-treeview mpg-layout">
                <li class="nav-item mpg-layout">
                  <a href="<?php echo e(route('recp.dashboard')); ?>" class="nav-link mpg-layout <?php echo e(request()->routeIs('recp.dashboard') ? 'active' : ''); ?>">
                    <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">Overview</p>
                  </a>
                </li>
                <li class="nav-item mpg-layout">
                  <a href="<?php echo e(route('recp.students.list')); ?>" class="nav-link mpg-layout <?php echo e(request()->routeIs('recp.students.list') ? 'active' : ''); ?>">
                    <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">Students</p>
                  </a>
                </li>
                <li class="nav-item mpg-layout">
                  <a href="<?php echo e(route('recp.students.create')); ?>" class="nav-link mpg-layout <?php echo e(request()->routeIs('recp.students.create') ? 'active' : ''); ?>">
          ...
          <?php if(!$isReceptionOnly): ?>
            ...
            <?php if(in_array(3, $userPrivileges)): ?>
              <li class="nav-header mpg-layout">Sales & CRM</li>

              <li class="nav-item mpg-layout">
                <a href="<?php echo e(route('admin.followups.index')); ?>"
                   class="nav-link mpg-layout <?php echo e(request()->routeIs('admin.followups.*') ? 'active' : ''); ?>">
                  <i class="nav-icon fas fa-address-book mpg-layout"></i><p class="mpg-layout">Follow-Ups</p>
                </a>
              </li>

              <li class="nav-item mpg-layout">
                <a href="<?php echo e(route('customer.show')); ?>" class="nav-link mpg-layout">
                  <i class="nav-icon fas fa-users mpg-layout"></i><p class="mpg-layout">Customers</p>
                </a>
              </li>
  <li class="nav-item has-treeview mpg-layout">
    <a href="#" class="nav-link mpg-layout <?php echo e(request()->is('admin/smmx*') ? 'active' : ''); ?>">
    ...
    <ul class="nav nav-treeview mpg-layout">
      <li class="nav-item mpg-layout">
        <a href="<?php echo e(route('admin.smmx.customers.index')); ?>"
           class="nav-link mpg-layout <?php echo e(request()->routeIs('admin.smmx.customers.*') ? 'active' : ''); ?>">
      ...
      <li class="nav-item mpg-layout">
        <a href="<?php echo e(route('admin.smmx.onboarding.index')); ?>"
           class="nav-link mpg-layout <?php echo e(request()->routeIs('admin.smmx.onboarding.*') ? 'active' : ''); ?>">
          <i class="far fa-circle nav-icon mpg-layout"></i>
    ...
    <li class="nav-item mpg-layout">
      <a href="<?php echo e(route('admin.smmx.deliverables.index')); ?>"
         class="nav-link mpg-layout <?php echo e(request()->routeIs('admin.smmx.deliverables.*') ? 'active' : ''); ?>">
        <i class="far fa-circle nav-icon mpg-layout"></i>
    ...
    <li class="nav-item mpg-layout">
      <a href="<?php echo e(route('admin.smmx.reports.index')); ?>"
         class="nav-link mpg-layout <?php echo e(request()->routeIs('admin.smmx.reports.*') ? 'active' : ''); ?>">
        <i class="far fa-circle nav-icon mpg-layout"></i>
        <p class="mpg-layout">Reports</p>
              ...
              <li class="nav-item has-treeview mpg-layout">
                ...
                <ul class="nav nav-treeview mpg-layout">
                  <li class="nav-item mpg-layout">
                    <a href="<?php echo e(route('quotation.generate')); ?>" class="nav-link mpg-layout">
                      <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">Quotation Generator</p>
                    </a>
                  </li>
                  <li class="nav-item mpg-layout">
                    <a href="<?php echo e(route('item.show')); ?>" class="nav-link mpg-layout">
              ...
              <li class="nav-item mpg-layout">
                <a href="<?php echo e(url('/ad-management')); ?>" class="nav-link mpg-layout <?php echo e(request()->is('ad-management*') ? 'active' : ''); ?>">
            ...
            <?php if(in_array(6, $userPrivileges) || in_array(7, $userPrivileges) || in_array(4, $userPrivileges)): ?>
              <li class="nav-header mpg-layout">Billing & Finance</li>

              <?php if(in_array(6, $userPrivileges)): ?>
                <li class="nav-item has-treeview mpg-layout">
                  <a href="#" class="nav-link mpg-layout">
                  ...
                  <ul class="nav nav-treeview mpg-layout">
                    <li class="nav-item mpg-layout">
                      <a href="<?php echo e(route('invoice.pendingBills')); ?>" class="nav-link mpg-layout">
                        <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">Requires Bill</p>
                      </a>
                    </li>
                    <li class="nav-item mpg-layout">
                      <a href="<?php echo e(route('invoice.add')); ?>" class="nav-link mpg-layout">
                        <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">New Invoice</p>
                      </a>
                    </li>
                    <li class="nav-item mpg-layout">
                      <a href="<?php echo e(route('invoice.list')); ?>" class="nav-link mpg-layout">
              ...
              <?php if(in_array(7, $userPrivileges)): ?>
                <li class="nav-item has-treeview mpg-layout">
                  <a href="#" class="nav-link mpg-layout">
                  ...
                  <ul class="nav nav-treeview mpg-layout">
                    <li class="nav-item mpg-layout">
                      <a href="<?php echo e(route('card.show')); ?>" class="nav-link mpg-layout">
                        <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">Manage</p>
                      </a>
                    </li>
                    <li class="nav-item mpg-layout">
                      <a href="<?php echo e(route('all_in_one')); ?>" class="nav-link mpg-layout">
                        <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">All Details</p>
                      </a>
                    </li>
                    <li class="nav-item mpg-layout">
                      <a href="<?php echo e(route('credit.show')); ?>" class="nav-link mpg-layout">
                        <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">Credit Detail</p>
                      </a>
                    </li>
                    <li class="nav-item mpg-layout" style="display: <?php echo e($isSuperAdmin ? 'block' : 'none'); ?>;">
                      <a href="<?php echo e(route('credit.summary')); ?>" class="nav-link mpg-layout">
                        <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">Credit Summary</p>
                      </a>
                    </li>
                    <li class="nav-item mpg-layout">
                      <a href="<?php echo e(route('debit.show')); ?>" class="nav-link mpg-layout">
                        <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">Debit Detail</p>
                      </a>
                    </li>
                    <li class="nav-item mpg-layout" style="display: <?php echo e($isSuperAdmin ? 'block' : 'none'); ?>;">
                      <a href="<?php echo e(route('debit.summary')); ?>" class="nav-link mpg-layout">
              ...
              <?php if(in_array(4, $userPrivileges)): ?>
                <li class="nav-item has-treeview mpg-layout">
                  <a href="#" class="nav-link mpg-layout">
            ...
            <?php if(in_array(2, $userPrivileges)): ?>
              ...
              <li class="nav-item has-treeview mpg-layout">
                ...
                <ul class="nav nav-treeview mpg-layout">
                  <li class="nav-item mpg-layout">
                    <a href="<?php echo e(route('ads.show')); ?>" class="nav-link mpg-layout">
                  ...
                  <li class="nav-item mpg-layout">
                    <a href="https://app.mpg.com.np/duty-schedule" target="_blank" rel="noopener noreferrer"
                       class="nav-link mpg-layout <?php echo e(request()->is('duty-schedule*') ? 'active' : ''); ?>">
                      <i class="fa fa-calendar-check nav-icon mpg-layout"></i><p class="mpg-layout">Duty Schedule</p>
                    </a>
                  </li>
                  <li class="nav-item mpg-layout">
                    <a href="<?php echo e(route('ads_complete.show')); ?>" class="nav-link mpg-layout">
                      <i class="far fa-circle nav-icon mpg-layout"></i><p class="mpg-layout">Previous Records</p>
                    </a>
                  </li>
                  <li class="nav-item mpg-layout" style="display: <?php echo e($isSuperAdmin ? 'block' : 'none'); ?>;">
                    <a href="<?php echo e(route('ads.summary')); ?>" class="nav-link mpg-layout">
              ...
              <li class="nav-item mpg-layout">
                <a href="<?php echo e(route('admin.daily-logs.index')); ?>"
                   class="nav-link mpg-layout <?php echo e(request()->routeIs('admin.daily-logs.*') ? 'active' : ''); ?>">
            ...
            <li class="nav-item mpg-layout">
              <a href="<?php echo e(route('admin.multimedia.index')); ?>"
                 class="nav-link mpg-layout <?php echo e(request()->routeIs('admin.multimedia.*') ? 'active' : ''); ?>">
            ...
            <li class="nav-item mpg-layout">
              <a href="<?php echo e(url('/admin/packages')); ?>"
                 class="nav-link mpg-layout <?php echo e(request()->is('admin/packages*') ? 'active' : ''); ?>">
            ...
            <?php if(in_array(3, $userPrivileges)): ?>
              ...
              <li class="nav-item mpg-layout">
                <a href="<?php echo e(route('admin.chat.internal')); ?>" class="nav-link mpg-layout">
            ...
            <li class="nav-item mpg-layout">
              <a href="<?php echo e(route('admin.uscalendar.index')); ?>"
                 class="nav-link mpg-layout <?php echo e(request()->routeIs('admin.uscalendar.index') ? 'active' : ''); ?>">
  ...
  <footer class="main-footer mpg-layout">
    <strong>Copyright © 2017-<?php echo e(date('Y')); ?>
...
<?php echo $__env->yieldContent('js_'); ?>
...
(function(){
  ...
  // ===== Weather =====
  const url = `<?php echo e(route('api.weather')); ?>?city=Pokhara,NP`;
  ...
  // ===== Banks (FAST copy) =====
  const BANK_DATA = <?php echo json_encode($bankData, 15, 512) ?>;
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  const fetchUrl = "<?php echo e(route('admin.bonus-season.show')); ?>";
  const storeUrl = "<?php echo e(route('admin.bonus-season.store')); ?>";
  const deactivateUrl = "<?php echo e(route('admin.bonus-season.deactivate')); ?>";
...
<?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/admin/layout/layout.blade.php ENDPATH**/ ?>