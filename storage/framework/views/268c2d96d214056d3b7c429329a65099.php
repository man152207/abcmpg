...
<?php $__env->startSection('title', 'Daily Card Spend Record Sheet'); ?>
...
<div class="container">
    ...
    <div class="card-totals-row">
        <?php $__currentLoopData = $cardTotals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cardName => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('daily-card-spends.view', $cardName)); ?>" style="text-decoration: none;">
                <div class="card-box">
                    <h5><?php echo e($cardName); ?></h5>
    ...
    <form action="<?php echo e(route('daily-card-spends.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="form-row" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: flex-end;">
        ...
        <div class="form-group" style="flex: 1; min-width: 200px;">
            ...
            <select name="card_name" id="card_name" class="form-control js-example-basic-single" required>
                ...
                <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($card->name); ?>"><?php echo e($card->name); ?> - $<?php echo e($card->USD); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
                ...
                <?php $__currentLoopData = $groupedAdAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $accounts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <optgroup label="<?php echo e($groupName); ?>">
                        <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($account->ad_account_name); ?>"><?php echo e($account->ad_account_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </optgroup>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        ...
        <div class="form-group" style="flex: 1; min-width: 200px;">
            ...
            <input type="date" name="date" id="date" class="form-control" value="<?php echo e(now()->toDateString()); ?>" required>
        </div>
    ...
    <table>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr id="record-<?php echo e($record->id); ?>">
                    <td><?php echo e($record->card_name); ?></td>
                    <td><?php echo e($record->ad_account); ?></td>
                    <td><?php echo e($record->date); ?></td>
                    <td><input type="number" step="0.01" id="amount-<?php echo e($record->id); ?>" value="<?php echo e($record->amount_usd); ?>" class="form-control"></td>
                    <td><input type="text" id="description-<?php echo e($record->id); ?>" value="<?php echo e($record->description); ?>" class="form-control"></td>
                    <td>
                        <button class="btn btn-primary btn-sm update-record" data-id="<?php echo e($record->id); ?>">Update</button>
                        <button class="btn btn-danger btn-sm delete-button" data-id="<?php echo e($record->id); ?>">Delete</button>
                    </td>
                </tr>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.update-record').forEach(button => {
            button.addEventListener('click', function () {
                ...
                fetch(`<?php echo e(url('daily-card-spends')); ?>/${recordId}`, {
                    method: 'PUT',
                    headers: {
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/admin/DCSRS/index.blade.php ENDPATH**/ ?>