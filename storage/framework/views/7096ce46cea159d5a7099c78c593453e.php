...
<div id="logShow" class="card">
  ...
  <div class="card-header2">
    <div>
      Daily Log – <?php echo e(optional($log->log_date)->format('Y-m-d') ?? '—'); ?>

      <div style="font-size:12.5px;color:var(--muted);font-weight:500">Readable summary and structured record of the day</div>
    </div>
    <span class="badge <?php echo e($badgeClass); ?>"><?php echo $badgeIcon; ?> <?php echo e(strtoupper($log->status)); ?></span>
  </div>

  <div class="card-body2">
    <div class="toolbar" style="margin-bottom:12px">
      <a href="<?php echo e(url()->previous()); ?>" class="btn btn-outline">
      ...
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update',$log)): ?>
        <a href="<?php echo e(route('admin.daily-logs.edit',$log)); ?>" class="btn btn-primary">
      ...
      <div class="pillbar">
        <a href="<?php echo e($urlAll); ?>" class="pill <?php echo e($deptShow==='all'  ? 'active' : ''); ?>">All</a>
        <a href="<?php echo e($urlProd); ?>" class="pill <?php echo e($deptShow==='prod' ? 'active' : ''); ?>">
          Production <?php if($prodCount): ?> <span class="count"><?php echo e($prodCount); ?></span> <?php endif; ?>
        </a>
        <a href="<?php echo e($urlRec); ?>" class="pill <?php echo e($deptShow==='rec'  ? 'active' : ''); ?>">
          Reception <?php if($recCount): ?> <span class="count"><?php echo e($recCount); ?></span> <?php endif; ?>
        </a>
        <a href="<?php echo e($urlOps); ?>" class="pill <?php echo e($deptShow==='ops'  ? 'active' : ''); ?>">
          Operations <?php if($opsCount): ?> <span class="count"><?php echo e($opsCount); ?></span> <?php endif; ?>
        </a>
      </div>
    </div>
    ...
    <div class="card-section">
      ...
      <div class="kv">
        <div class="item">
          ...
          <div class="v"><?php echo e(optional($log->log_date)->format('Y-m-d')); ?></div>
        </div>
        <?php if($isSuper): ?>
          <div class="item">
            <div class="k">Staff</div>
            <div class="v"><?php echo e($log->admin->name ?? '—'); ?></div>
          </div>
        <?php endif; ?>
      </div>
      <div class="summary">
        <div class="k" style="font-size:var(--fs-12);color:var(--muted);margin-bottom:6px">End-of-Day Notes</div>
        <div style="white-space:pre-wrap"><?php echo e($log->summary ?: '—'); ?></div>
      </div>
    </div>

    
    <?php if($deptShow==='all' || $deptShow==='prod'): ?>
      <?php
          ...
          <table class="view" aria-label="Production table">
            ...
            <tbody>
              <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><?php echo e($r[0] ?? ''); ?></td>
                  <td><?php echo e($r[1] ?? ''); ?></td>
                  <td><?php echo e($r[2] ?? ''); ?></td>
                  <td><?php echo e($r[3] ?? ''); ?></td>
                  <td><?php echo e($r[4] ?? ''); ?></td>
                  <td><?php echo e($r[5] ?? ''); ?></td>
                </tr>
      ...
      <?php elseif($deptShow==='prod'): ?>
        <div class="muted">No production entries.</div>
      <?php endif; ?>
    <?php endif; ?>

    
    <?php if($deptShow==='all' || $deptShow==='rec'): ?>
      <?php
      ...
      <?php elseif($deptShow==='rec'): ?>
        <div class="muted">No reception entries.</div>
      <?php endif; ?>
    <?php endif; ?>

    
    <?php if($deptShow==='all' || $deptShow==='ops'): ?>
      <?php
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpgcomnp/app.mpg.com.np/resources/views/admin/daily_logs/show.blade.php ENDPATH**/ ?>