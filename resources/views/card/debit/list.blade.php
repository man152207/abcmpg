    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header" style="display: inline-flex;">
                <h3>Debit List</h3>
                <div>
                    <a class="btn btn-primary" href="{{route('debit.add')}}" style=" margin-left:80%;display: inline-flex;">AddNew</a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('search_debit_list') }}" method="get">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-4">
                ...
                {{ $debits->appends(request()->query())->links('pagination::bootstrap-5')}}
            </div>
