...
<div class="container cardlist mt-5">
    <div class="card">
        <div class="card-header">
            <h3>Card List</h3>
            <a class="btn btn-primary btn-sm" href="{{ route('card.add') }}">Add New</a>
        </div>
        <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($cards->sortByDesc('status')->sortByDesc('USD') as $card)
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($card->status)
                                <form action="{{ route('card.suspend', $card->id) }}" method="post" style="display:inline;">
                                    @csrf
                            ...
                            @else
                                <form action="{{ route('card.reactivate', $card->id) }}" method="post" style="display:inline;">
                                    @csrf
