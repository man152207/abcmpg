...
<div class="container">
    <div class="top-summary-section">
        ...
        <div class="top-summary-card" style="background-color: #16a085;">
            <h4>My Order</h4>
            <p>Rs.{{ number_format($myOrderAmount, 2) }}</p>
        </div>
    ...
    <p>{{ $quantity }}</p>
        ...
        <div class="top-summary-card" style="background-color: #e74c3c;">
            ...
            <p>Rs.{{ number_format($dueAmount, 2) }}</p>
        </div>

        <!-- Paid Invoice -->
        <div class="top-summary-card" style="background-color: #2ecc71;">
            <h4>Paid Invoice</h4>
            <p>Rs.{{ number_format($paidInvoice, 2) }}</p>
        </div>
    ...
    <div class="summary-section">
        <div class="summary-card">
            ...
            <p>Rs.{{ number_format($totalNPRThisMonth, 2) }}</p>
        </div>
        <div class="summary-card">
            <h4>Total Quantity (This Month)</h4>
            <p>{{ $totalQuantityThisMonth }}</p>
        </div>
    </div>
...
<div class="table-section">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px;">
        ...
        <div>
            <a href="javascript:void(0)" class="btn btn-secondary" id="prev-btn" data-offset="{{ $offset - 5 }}">New</a>
            <a href="javascript:void(0)" class="btn btn-secondary" id="next-btn" data-offset="{{ $offset + 5 }}">Old</a>
        </div>
    </div>
