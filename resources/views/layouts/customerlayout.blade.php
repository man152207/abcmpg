...
<body>
    ...
    <div class="custom-profile-card">
        <div class="profile-image-wrapper">
            <img src="{{ $customer->profile_picture ? asset('uploads/customers/' . $customer->profile_picture) : asset('uploads/customers/default.jpg') }}" alt="Profile Picture">
        </div>
        <div class="profile-details">
            <h3 class="customer-name">{{ $customer->name }}</h3>
            <p class="customer-info"><i class="fas fa-user-circle"></i> {{ $customer->display_name }}</p>
            <p class="customer-info"><i class="fas fa-envelope"></i> {{ $customer->email }}</p>
            <p class="customer-info"><i class="fas fa-phone-alt"></i> {{ $customer->phone }}</p>
            <p class="customer-info"><i class="fas fa-map-marker-alt"></i> {{ $customer->address }}</p>
        </div>
        <div class="rate-card">
            <p>Rate: <strong>{{ $usdRate }}</strong></p>
        </div>
    </div>
@else
    <div class="custom-profile-card">
...
@endif
        ...
        <a href="{{ url('/portal/dashboard') }}"><i class="fas fa-tachometer-alt"></i> <span class="menu-text">Dashboard</span></a>
        <a href="#"><i class="fas fa-shopping-cart"></i> <span class="menu-text">Orders</span></a>
        <a href="{{ route('portal.adsinsights') }}"><i class="fas fa-chart-line"></i> <span class="menu-text">Campaign Reports</span></a>
        <a href="{{ route('portal.invoices') }}"><i class="fas fa-file-invoice"></i> <span class="menu-text">Invoice</span></a>
        <a href="{{ url('/portal/profile-settings') }}"><i class="fas fa-user"></i> <span class="menu-text">Profile</span></a>
...
<a href="{{ url('/portal/dashboard') }}" style="text-decoration: none;color: white;font-weight: 600;font-size: 25px;">Customer Portal</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="{{ url('/portal/profile-settings') }}">Settings</a>
        ...
        <footer>
            &copy; {{ date('Y') }} Customer Portal. All rights reserved.
        </footer>
    </div>
