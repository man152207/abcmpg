...
@endpush
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.smmx.deliverables.store') }}" method="POST">
                @csrf
                <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="package_id" class="form-control">
                                        ...
                                        @foreach($packages as $package)
                                            <option value="{{ $package->id }}">{{ $package->name ?? ('Package #'.$package->id) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="onboarding_id" class="form-control">
                                        ...
                                        @foreach($onboardings as $onboarding)
                                            <option value="{{ $onboarding->id }}">{{ $onboarding->business_name }} (#{{ $onboarding->id }})</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
