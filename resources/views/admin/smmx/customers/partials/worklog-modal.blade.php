...
<div class="modal fade" id="workLogModal" tabindex="-1" role="dialog" aria-labelledby="workLogModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('admin.smmx.customers.worklog.store', $customer->id) }}" method="POST">
            @csrf
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Month</label>
                                <input type="number" name="report_month" class="form-control" value="{{ now()->month }}" min="1" max="12" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Year</label>
                                <input type="number" name="report_year" class="form-control" value="{{ now()->year }}" min="2000" max="2100" required>
                            </div>
                        </div>
                    </div>
