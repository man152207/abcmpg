...
<body>
    ...
    <div class="receipt-container">
        <div class="receipt-header">
            <div>
                <h1>Receipt</h1>
<div style="padding: 2.5px;">Date {{ $ad->created_at ? $ad->created_at->format('F j, Y') : '' }}</div>
            </div>
            <div>
<img src="{{ asset('images/logo.png') }}" alt="Logo" style="max-height: 60px;">
        ...
        <div class="receipt-details">
            ...
            <div>
                ...
                <p>{{ $customer->email }}</p>
                <p>{{ $customer->phone }}{{ $customer->phone_2 ? ', ' . $customer->phone_2 : '' }}</p>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>Ad Service (Unit {{ $i }})</td>
                    <td>1</td>
                    <td>Rs {{ number_format($ad->NRP / $ad->Quantity, 2) }}</td>
                    <td>Rs {{ number_format($ad->NRP / $ad->Quantity, 2) }}</td>
                </tr>
                @endfor
            </tbody>
        ...
        <div style="text-align: center;">
            <a href="{{ url('/receipt/pdf_gen/' . $ad->id) }}" class="btn">Download Receipt</a>
        </div>
    </div>
</body>
</html>
